...
function Signup() {
  ...
  const styles = {
    main_box: `bg-high_contrast_yellow w-full drop-shadow-3xl border-4 flex flex-col justify-around p-10`,
    input_bg: `h-12 mt-5 mb-5 flex justify-between`,
    small_input_box: `bg-white border-2 drop-shadow-2xl w-8/12 h-full`,
